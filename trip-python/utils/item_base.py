...
class Item_CF():
    def __init__(self, table_name):
        ...
        self.item_sim_path = './static/data/%s_item_sim.json'%table_name
        self.item_sim = None
    ...
    def load_action_data(self):
        return get_item_base_data(self.table_name)
...
if __name__ == "__main__":
    ...
    id_list = item_cf.get_one_recommend('13')
    print(id_list)